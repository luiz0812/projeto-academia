...
<?php
// Buscar alunos e planos para os selects
...
if ($_POST) {
    ...
    $sql = "INSERT INTO matriculas (aluno_id, plano_id, data_matricula, status)
            VALUES ($aluno_id, $plano_id, '$data', '$status')";
    if ($conn->query($sql)) {
        echo "<script>alert('Matrícula cadastrada!'); location.href='matriculas_lista.php';</script>";
    } else {
